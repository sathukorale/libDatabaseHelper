...
namespace libDatabaseHelperUnitTests.mysql
{
    ...
    public class MySqlTests
    {
        ...
        public void TEST_Setup()
        {
            ...
            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).DropTable<InvalidSampleTable3NoPrimaryKey>();
            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).DropTable<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>();
        ...
        public void TEST_Cleanup()
        {
            ...
            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).DropTable<InvalidSampleTable3NoPrimaryKey>();
            Assert.IsFalse(GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).TableExist<InvalidSampleTable3NoPrimaryKey>());

            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).DropTable<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>();
            Assert.IsFalse(GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).TableExist<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>());
        ...
        public void CreateInsertAndDeleteSingle_SampleTable1()
        {
            ...
            var fetchedEntries = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).Select<SampleTable1>();
            ...
            fetchedEntries = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).Select<SampleTable1>();
        ...
        public void CreateInsertUpdateAndDeleteMultiple_SampleTable1()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                var fetchedEntries = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).Select<SampleTable1>(new[] { new Selector("Column1", insertedEntry.Column1) });
                Assert.IsTrue(fetchedEntries.Length == 1);
                ...
                fetchedEntries = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).Select<SampleTable1>(new[] { new Selector("Column1", insertedEntry.Column1) });
                Assert.IsTrue(fetchedEntries.Length == 1);
        ...
        public void ReferenceKeyViolationException_SampleTable1_2()
        {
            ...
            Assert.IsTrue(GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).Select<SampleTable1>(new[] { new Selector("Column1", insertedEntry.Column1) }).Length == 1);
        }
        ...
        public void AttemptActionsOnTableWithNoPrimaryKey_SampleTable3()
        {
            try
            {
                GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).CreateTable<InvalidSampleTable3NoPrimaryKey>();
                Assert.Fail("No Error was Thrown !");
            }
        ...
        public void AttemptOnCreatingTableWithNoColumns_SampleTable4()
        {
            try
            {
                GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).CreateTable<InvalidSampleTable4NoColumns>();
                Assert.Fail("No Error was Thrown !");
            }
            catch (System.Exception ex)
            {
        ...
        {
            GenericConnectionManager.GetConnectionManager(DatabaseType.MySQL).SetConnectionString<Database1NormalTable1>("Server=127.0.0.1;Database=sampleDatabase1;Uid=root;Pwd=Password12!;");
            GenericConnectionManager.GetConnectionManager(DatabaseType.MySQL).SetConnectionString<Database2NormalTable2>("Server=127.0.0.1;Database=sampleDatabase2;Uid=root;Pwd=Password12!;");

            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).CreateTable<Database1NormalTable1>();
            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).CreateTable<Database2NormalTable2>();
            ...
            var fetchedEntries1 = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).Select<Database1NormalTable1>();
            var fetchedEntries2 = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).Select<Database2NormalTable2>();
            ...
            fetchedEntries1 = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).Select<Database1NormalTable1>();
            Assert.IsTrue(fetchedEntries1.Length == 0);

            fetchedEntries2 = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).Select<Database2NormalTable2>();
        ...
        {
            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).CreateTable<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>();
            //
            // Checking the table structure
            {
                var availableColumns = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).GetTableFields<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>();
                var availablePrimaryColumns = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).GetPrimaryKeyDetails<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>();
            ...
            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).CreateTable<ChangingPrimaryKeyTestNamespace_RemovingPrimaryKey.SimpleNormalTable>();
            //
            // Checking the table structure
            {
                var availableColumns = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).GetTableFields<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>();
        ...
        public void AddingAKeyToACompositePrimaryKeyAndCheckingWhetherTheChangeIsPresentOnTheDatabase()
        {
            ...
            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).CreateTable<ChangingPrimaryKeyTestNamespace_AddingPrimaryKey.SimpleNormalTable>();
            //
            // Checking the table structure
            {
                var availableColumns = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).GetTableFields<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>();
        ...
        public void RemovingAKeyAndTheCorrespondingColumnFromACompositePrimaryKeyAndCheckingWhetherTheChangeIsPresentOnTheDatabase()
        {
            ...
            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).CreateTable<ChangingPrimaryKeyTestNamespace_RemovingPrimaryKeyColumn.SimpleNormalTable>();
            //
            // Checking the table structure
            {
                var availableColumns = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).GetTableFields<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>();
        ...
        public void AddingAKeyAndTheCorrespondingColumnToACompositePrimaryKeyAndCheckingWhetherTheChangeIsPresentOnTheDatabase()
        {
            ...
            GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).CreateTable<ChangingPrimaryKeyTestNamespace_AddingPrimaryKeyColumn.SimpleNormalTable>();
            //
            // Checking the table structure
            {
                var availableColumns = GenericDatabaseManager.GetDatabaseManager(DatabaseType.MySQL).GetTableFields<ChangingPrimaryKeyTestNamespace_Original.SimpleNormalTable>();
